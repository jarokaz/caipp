...
PIPELINE_NAME=os.getenv("PIPELINE_NAME", "covertype-training")
...
DEFAULT_TRAIN_STEPS=os.getenv("DEFAULT_TRAIN_STEPS", 100)
DEFAULT_EVAL_STEPS=os.getenv("DEFAULT_EVAL_STEPS", 50)
DEFAULT_DATA_ROOT=os.getenv("DEFAULT_DATA_ROOT", "gs://workshop-datasets/covertype/small")
DATAFLOW_TEMP_LOCATION=os.getenv("DATAFLOW_TEMP_LOCATION", "gs://jk-techsummit-bucket/tmp")
DATAFLOW_DISK_SIZE=os.getenv("DATAFLOW_DISK_SIZE", "50")
DATAFLOW_MACHINE_TYPE=os.getenv("DATAFLOW_MACHINE_TYPE", "e2-standard-8")
DEFAULT_SCHEMA_FOLDER_URI=os.getenv("DEFAULT_SCHEMA_FOLDER_URI", "gs://jk-techsummit-bucket/schema")
